...
const selecteerPersoon = () => {
        ...
        let lijst2 = document.getElementById("lstPersonen");
        let index = lijst2.selectedIndex;
...
const setup = () => {
    ...
    let selecteer = document.getElementById("lstPersonen");
    selecteer.addEventListener("click",selecteerPersoon);
